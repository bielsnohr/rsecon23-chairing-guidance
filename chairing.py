...
BASE_DOC = [
    ...
    "In case you need it, the username for the PC in the room is <b>{login_username}</b>, and the password is <b>{login_password}</b>, but again, your room volunteer should be able to handle anything with this machine.",
