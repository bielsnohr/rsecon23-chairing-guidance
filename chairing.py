...
BASE_DOC = [
    ...
    "After each talk is 5 minutes of Q&amp;A. The volunteer will switch the display to show the Slido wall view. Invite the audience to ask questions and upvote others' questions at the link on screen.",
    "Read out the questions from Slido in descending order of upvotes. If there are no questions on Slido at the start of the Q&amp;A then please ask one or two questions yourself.",
